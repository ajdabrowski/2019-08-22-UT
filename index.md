...
venue: "University of Texas at Austin"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Learning Lab 4, Perry-Castañeda Library"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Jessica Trelogan", "Anna Dabrowski", "Emily Beagle", "Michael Shensky"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Elias Chalhoub", "Je’aime Powell", "Alice Macqueen"] # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["adabrowski@tacc.utexas.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
<div id="sql"> {% comment %} Start of 'SQLite' section. {% endcomment %}
  ...
  <p>
    SQL is a specialized programming language used with databases.  We use a simple database manager called DB Browser for
